window.PRODUTO = {
  ...
  estoque: "45 disponíveis",
  imagens: [
    "assets/modelo1.webp",
    "assets/modelo11.webp",
    "assets/modelo2.webp",
    "assets/modelo22.webp",
    "assets/modelo3.webp",
    "assets/modelo33.webp",
    "assets/modelo4.webp",
    "assets/modelo44.webp"
  ],
  descricao: [
    "KIT composto por 10 peças (05 Conjuntos) de Verão para meninas!",
    "",
    ...
    "",
    "Caso queira outro kit, nos chame! Temos diversos diferentes com preços superacessíveis também :)",
    "",
    "Garantia do vendedor: 30 dias"
  ]
};

// Sincronização e inicialização (mesma lógica do original)
  ...
  var variacoes = [
    {
      "variação": "Cor",
      "valores": [
        { "titulo": "Cor", "valor": "Modelo 1", "imagem": "assets/modelo1.webp", "fullid": "" },
        { "titulo": "Cor", "valor": "Modelo 2", "imagem": "assets/modelo2.webp", "fullid": "" },
        { "titulo": "Cor", "valor": "Modelo 3", "imagem": "assets/modelo3.webp", "fullid": "" },
        { "titulo": "Cor", "valor": "Modelo 4", "imagem": "assets/modelo4.webp", "fullid": "" }
      ]
    },
    {
      "variação": "Tamanho",
...
(function(){
  ...
  const reviews = [
    ...
    {
      stars: 5,
      text: 'Lindo,minha filha tem 3 anos é magra mas é alta o tamanho 4 deu certinho,são de ótima qualidade estou até comprando mais agora kk.',
      days: '03 set. 2024',
