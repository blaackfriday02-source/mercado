...
window.addEventListener("DOMContentLoaded", function () {
  ...
  try{
    ...
    var car1 = [
      {
        name: 'Geral',
        values: [
          { name: 'Marca', value: '(editar)' },
          { name: 'Modelo', value: '(editar)' },
          { name: 'Material', value: '(editar)' },
          { name: 'Conteúdo da embalagem', value: '(editar)' }
        ]
      }
    ];
    ...
    set_cookie('produto_avaliação_por_caracteristicas', JSON.stringify(['Qualidade','Conforto','Custo-benefício']));
